...
public:
   ...
   LinkedBag unionBag(const LinkedBag& otherBag) const;
   LinkedBag intersection(const LinkedBag& otherBag) const;
   LinkedBag difference(const LinkedBag& otherBag) const;
}; // end LinkedBag
